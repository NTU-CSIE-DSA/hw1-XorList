# [HW1.P3] XOR Linked List Tutorial
Keywords: `XOR linked list`.
...
## common mistakes
1. Make sure you have avoided the NULL case while implementing the routines.
2. If you had followed the instructions and pseudo code and still found out not passing this question, you should review yourself about truly understanding the principles of XOR linked list.
